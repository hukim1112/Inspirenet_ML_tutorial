...
def build_model_columns():
  ...
  base_columns = [
      UserID, Gender, Age, Occupation, Zipcode, crossed_column_genres
  ]

  crossed_columns = [
      tf.feature_column.crossed_column(
          [crossed_column_genres, 'UserID'], hash_bucket_size=10000),
      tf.feature_column.crossed_column(
          [crossed_column_genres, 'Age'], hash_bucket_size=10000),
      tf.feature_column.crossed_column(
          [crossed_column_genres, 'Occupation'], hash_bucket_size=10000),
      tf.feature_column.crossed_column(
